...
def msgfin():
    chaine="Game over"
    font=pygame.font.SysFont("Arial",200,bold=False,italic=False)
...
def msgrejouer():
    ...
    font=pygame.font.SysFont("Arial",45,bold=False,italic=False)
    text=font.render(chaine,1,(255,180,10))
    text1=font.render(chaine1,1,(255,180,10))
    fenetre.blit(text,(310,550))
    fenetre.blit(text1,(60,500))
...
def msgscoremax(points) :
    ...
    font=pygame.font.SysFont("Arial",95,bold=False,italic=False)
    text=font.render(chaine,1,(100,150,20))
    fenetre.blit(text,(10,330))
    fichier.close()
...
def jeux():
    ...
    fichier= open("dataperso.rtf", "r")
    perso= pygame.image.load(fichier.read()).convert_alpha()
    fichier.close()
...
def choixperso():
    ...
    persochoix=pygame.image.load("persochoix.png").convert_alpha()
    perso2choix=pygame.image.load("perso2choix.png").convert_alpha()

    chaine='choisir son oiseau avec les flèches "<-" ou "->"'
    chaine2='Puis appuyer sur "Echap" pour revenir au menu principal'
    font=pygame.font.SysFont("Arial",50,bold=False,italic=False)
    font2=pygame.font.SysFont("Arial",50,bold=False,italic=False)
    text= font.render(chaine,1,(00,00,00))
    text2= font2.render(chaine2,1,(00,00,00))
    fenetre.blit(fond,(0,0))
    fenetre.blit(text,(80,50))
    fenetre.blit(text2,(50,200))
    fenetre.blit(perso,(100,300))
    fenetre.blit(perso2,(750,300))
    ...
    while continuer:
        for event in pygame.event.get():
            ...
            if event.type==KEYDOWN :
                if event.key==K_LEFT:
                    fichier= open("dataperso.rtf", "w")
                    fenetre.blit(fond,(0,0))
                    fenetre.blit(text,(40,50))
                    fenetre.blit(text2,(50,200))
                    fenetre.blit(persochoix,(100,300))
                    fenetre.blit(perso2,(750,300))
                    fichier.write("perso.png")
                    pygame.display.flip()
                    fichier.close()
                if event.key==K_RIGHT:
                    ...
                    fenetre.blit(text2,(50,200))
                    fenetre.blit(perso,(100,300))
                    fenetre.blit(perso2choix,(750,300))
                    fichier.write('perso2.png')
                    pygame.display.flip()
                    fichier.close()
...
def lancement():
    ...
    fond2=pygame.transform.scale(fond2,(largeur,hauteur))
    points=0
    commencer = 1
    ...
    chaine5= '- Appuyer sur "ENTRER" pour choisir votre oiseau'
    chaine6= '- Appuyer sur "ESPACE" pour commencer'
    font=pygame.font.SysFont("Arial",40,bold=False,italic=False)
    font2=pygame.font.SysFont("Arial",130,bold=False,italic=False)
    text1= font.render(chaine1,1,(0,0,0))
    text2= font2.render(chaine2,1,(10,20,200))
    text3=font.render(chaine3,1,(0,0,0))
    text5=font.render(chaine5,1,(0,0,0))
    text6=font.render(chaine6,1,(0,0,0))
    fenetre.blit(text1,(10,420))
    fenetre.blit(text2,(40,10))
    fenetre.blit(text3,(10,250))
    fenetre.blit(text5,(10,550))
    fenetre.blit(text6,(10,200))
    msgscoremax(points)
    pygame.display.flip()
    while commencer :
        for event in pygame.event.get():
